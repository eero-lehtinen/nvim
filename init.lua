  ...
  { 'folke/which-key.nvim', opts = {} },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        vim.keymap.set('n', ']c', require('gitsigns').next_hunk, { buffer = bufnr, desc = 'Next [C]hange (Hunk)' })
        vim.keymap.set('n', '[c', require('gitsigns').prev_hunk, { buffer = bufnr, desc = 'Previous [C]hange (Hunk)' })
        vim.keymap.set('n', '<leader>ph', require('gitsigns').preview_hunk, { buffer = bufnr, desc = '[H]unk [P]review' })
        vim.keymap.set('n', '<leader>rh', require('gitsigns').reset_hunk, { buffer = bufnr, desc = '[H]unk [R]eset' })
      end,
    },
  },
