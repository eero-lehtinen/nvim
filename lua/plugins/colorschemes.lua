    ...
    opts = {
      ...
      overrides = function(colors)
        ...
        return {
          ...
          SnacksPickerBorder = { bg = theme.ui.bg, fg = colors.palette.sumiInk6 },
          SnacksPickerTitle = { bg = theme.ui.bg, fg = colors.palette.sumiInk6 },
          -- SnacksPickerDir = { bg = "none", fg = theme.ui.fg },
